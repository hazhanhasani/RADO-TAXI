...
class LiveTripSnapshot {
  ...
  factory LiveTripSnapshot.fromJson(Map<String, dynamic> j) => LiveTripSnapshot(
    ...
    driverPosition: j['driver_position'] is Map
        ? LiveDriverPosition.fromJson(
            (j['driver_position'] as Map).cast<String, dynamic>(),
          )
        : null,
    eta: j['eta'] is Map
        ? LiveEta.fromJson((j['eta'] as Map).cast<String, dynamic>())
        : null,
    driverProfile: j['driver_profile'] is Map
        ? LiveDriverProfile.fromJson(
            (j['driver_profile'] as Map).cast<String, dynamic>(),
          )
        : null,
...
class LiveDriverPosition {
  ...
  factory LiveDriverPosition.fromJson(Map<String, dynamic> j) {
    final seen =
        (j['last_seen_at'] as Map?)?.cast<String, dynamic>() ?? const {};
...
class LiveDriverProfile {
  ...
  factory LiveDriverProfile.fromJson(Map<String, dynamic> j) =>
      LiveDriverProfile(
